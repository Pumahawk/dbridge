...
public class ProjectExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleSpelExceptionEntity(final SpelEvaluationException ex)
      throws Exception {
    ...
    if (exs != null) {
      ...
      throw new ResponseStatusException(
          HttpStatus.INTERNAL_SERVER_ERROR, "Unable to wrap SpelEvaluationException", ex);
    }
  }

  @ExceptionHandler({ProjectException.class})
  public ResponseEntity<ErrorResponse> handleAccessDeniedException(ProjectException ex) {
