...
public class SpelConfiguration {
    ...
    @Bean
    public List<SpelMethodsDeclaration> spelMethodsDeclarationClazz(Map<String, String> spelMethodsDeclaration) {
    ...
    public EvaluationContext createEvaluationContext() {
        try {
            ...
            List<SpelMethodsDeclaration> spelMethodsDeclarationClazz = (List<SpelMethodsDeclaration>) applicationContext.getBean("spelMethodsDeclarationClazz");
