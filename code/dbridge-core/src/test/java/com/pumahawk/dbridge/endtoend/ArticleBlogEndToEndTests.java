...
public class ArticleBlogEndToEndTests extends BlogPostgresEndToEndTests {
  ...
  public void getArticles() {
    ...
    client().get().uri("/articles").exchange().expectBody().json(response, JsonCompareMode.LENIENT);
  }
  ...
  public void getArticlesByTitle() {
    ...
    client()
        .get()
        .uri(b -> b.path("/articles").queryParam("title", "fir").build())
        .exchange()
        .expectBody()
  ...
  public void multipleFilterById() {
    ...
    client()
        .get()
        .uri(b -> b.path("/articles").queryParam("id", "1", "2").build())
        .exchange()
        .expectBody()
        .json(response, JsonCompareMode.LENIENT);
  }
