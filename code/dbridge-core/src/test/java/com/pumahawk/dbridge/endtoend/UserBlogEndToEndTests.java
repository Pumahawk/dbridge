...
public class UserBlogEndToEndTests extends BlogPostgresEndToEndTests {
  ...
  public void getUsers() {
    ...
    client().get().uri("/users").exchange().expectBody().json(response, JsonCompareMode.LENIENT);
  }
  ...
  public void searchUsers_byName() {
    ...
    client()
        .get()
        .uri(b -> b.path("/users").queryParam("name", "mar").build())
        .exchange()
        .expectBody()
  ...
  public void searchUsers_byName_replaceSpecialCharacter() {
    ...
    client()
        .get()
        .uri(b -> b.path("/users").queryParam("name", "ma%r").build())
        .exchange()
        .expectBody()
        .json(response, JsonCompareMode.LENIENT);
  }
  ...
  public void searchUsers_byId() {
    ...
    client()
        .get()
        .uri(b -> b.path("/users").queryParam("id", "2").build())
        .exchange()
        .expectBody()
        .json(response, JsonCompareMode.LENIENT);
  }
  ...
  public void searchUsers_byId_badRequest() {
    ...
    client()
        .get()
        .uri(b -> b.path("/users").queryParam("id", "2", "aa").build())
        .exchange()
        .expectStatus()
        .isBadRequest();
  }
  ...
  public void searchWithLimitAndOffset() {
    ...
    client()
        .get()
        .uri(b -> b.path("/users").queryParam("limit", "1").queryParam("offset", "1").build())
        .exchange()
        .expectBody()
        .json(response, JsonCompareMode.LENIENT);
  }
  ...
  public void emptySearchUsers() {
    ...
    client()
        .get()
        .uri(b -> b.path("/users").queryParam("name", "zzzz").build())
        .exchange()
        .expectBody()
        .json(response, JsonCompareMode.LENIENT);
  }
  ...
  public void getById_notFound() {
    ...
    client()
        .get()
        .uri(b -> b.path("/users/{id}").build("554454"))
        .exchange()
        .expectStatus()
  ...
  public void getById_idNotNumber() {
    ...
    client()
        .get()
        .uri(b -> b.path("/users/{id}").build("id_12343"))
        .exchange()
        .expectStatus()
