...
public class ConfigurationLoaderTests {
  ...
  public void resourceDoesNotExist() {
    Exception e =
        assertThrows(
            Exception.class,
            () ->
                getCustomConfigurationLoader(
                    env -> env.setProperty(Properties.CONFIGURATION_PATH, "classpath:notfound")));
        ...
        assertThrows(
            ...
            () ->
                getCustomConfigurationLoader(
                    env ->
                        env.setProperty(
                            Properties.CONFIGURATION_PATH,
                            "file:" + getClass().getResource("isfile").getPath())));
    ConfigurationException ex = ExceptionUtils.throwableOfType(e, ConfigurationException.class);
  ...
  public void resourceIsInvalidTypeOfKind() {
    ConfigurationLoader rl =
        getCustomConfigurationLoader(
            env ->
                env.setProperty(
                    Properties.CONFIGURATION_PATH,
                    "file:" + getClass().getResource("invalid-kind").getPath()));
    ConfigurationException e =
        assertThrows(ConfigurationException.class, () -> rl.getConfigurationStore());
    ...
    ConfigurationLoader rl =
        getCustomConfigurationLoader(
            env ->
                env.setProperty(
                    Properties.CONFIGURATION_PATH,
                    "file:" + getClass().getResource("yaml-with-error").getPath()));
    ConfigurationException e =
        assertThrows(ConfigurationException.class, () -> rl.getConfigurationStore());
    ...
    ConfigurationLoader rl =
        getCustomConfigurationLoader(
            env ->
                env.setProperty(
                    Properties.CONFIGURATION_PATH,
                    "file:" + getClass().getResource("no-resources").getPath()));
