...
public class ExceptionUtilsTests {
  ...
  public static Stream<Arguments> exceptionUtilsThrow() {
    return Stream.of(
        arguments(
            ext(() -> ExceptionUtils.throwNotFound(null, "Obj1 not found")),
            ProjectException.class,
            "Obj1 not found"),
        arguments(
            ext(() -> ExceptionUtils.throwNotFound("Obj2 not found")),
            ProjectException.class,
            "Obj2 not found"),
        arguments(
            ext(
                () ->
                    ExceptionUtils.throwNotFoundFromList(
                        Collections.emptyList(), "Obj3 not found")),
            ProjectException.class,
            "Obj3 not found"));
  }
  ...
  @ParameterizedTest
  @MethodSource
  public void exceptionUtilsThrow(
      Executable execution, Class<?> classEcception, String exceptionMessage) {
    ...
    return Stream.of(
        ...
        arguments(
            sup(
                () ->
                    ExceptionUtils.throwNotFoundFromList(
                        Collections.singletonList(2), "Obj3 not found")),
            2));
  }
