...
public class StreamSpelUtilsTests {
  ...
  public void mapStream() throws NoSuchMethodException, SecurityException {
    Function<Object, Object> obj =
        StreamSpelUtils.fun(NumberUtils.class.getMethod("toInt", String.class));
  ...
  public void mapThrowIllegalArgument() throws NoSuchMethodException, SecurityException {
    Function<Object, Object> obj =
        StreamSpelUtils.fun(StringUtils.class.getMethod("difference", String.class, String.class));
    IllegalArgumentException ex =
        assertThrows(IllegalArgumentException.class, () -> obj.apply("1234"));
  ...
  public void predStream() throws NoSuchMethodException, SecurityException {
    List<String> values =
        Stream.of("a", "4", "10", "b")
            .filter(StreamSpelUtils.pred(NumberUtils.class.getMethod("isParsable", String.class)))
