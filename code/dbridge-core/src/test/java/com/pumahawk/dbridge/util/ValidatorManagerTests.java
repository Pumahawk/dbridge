...
public class ValidatorManagerTests {
  ...
  @ParameterizedTest
  @MethodSource
  public void correctValidationAndConvertion(
      String configurationKey, Object intput, Object expected)
  ...
  @ParameterizedTest
  @MethodSource
  public void inCorrectValidationAndConvertion(
      String configurationKey, Object intput, Object expectedMEssage)
      throws StreamReadException, DatabindException, IOException {
    BadRequestParameterExpeption ex =
        assertThrows(
            BadRequestParameterExpeption.class,
            () ->
                validatorManager.validate(
                    getParameterConfig(configurationKey), createContext(intput)));
  ...
  private Validator getParameterConfig(String key) {
    try {
      Map<String, Validator> configurations =
          new YAMLMapper()
              .readValue(
                  getClass().getResource("validators.yaml"),
                  new TypeReference<Map<String, Validator>>() {});
